...
Item {id:root
    property variant settings:[] //[Mandatory]
    property variant infoModelArray:[] //[Mandatory]
    property variant headerInfo:[] //[Mandatory]
    property variant displayTextArr: [] //[Mandatory]
    ...
    property variant groupArray: prepareExclusiveGroupArray()

    property variant barImgList: ["NW_Setting_Brown bar.png", "NW_Setting_Red bar.png",
        "NW_Setting_Blue bar.png", "NW_Setting_Green bar.png"]
    property variant chevronImg: ["chevron_right_brown.png", "chevron_right_red.png",
        "chevron_right_blue.png", "chevron_right_green.png"]
    property variant cursorImgList: ["NW_Setting_Brown cursor.png","NW_Setting_Red cursor.png",
        "NW_Setting_Blue cursor.png","NW_Setting_Green cursor.png",]
    property variant textColorList: ["#966a39", "#eb2228", "#0c7cae", "#50833d"]
    property var viewController
    ...
    DragMouseAndHint {
        target: root
        maxX: root.width
        toLeftToDo: viewController.makePreviousInvisible
        toRightToDo: viewController.pop
    ...
    Image{anchors.fill: parent; z: -1
        source: "qrc:/pic/background0.png"
    }
    AutoImage{anchors.centerIn: parent
        source: "qrc:/pic/NW_Setting_White frame BG.png"
    }
    AutoImage{x: 565*hRatio; y:21.5*vRatio
        source: "qrc:/pic/NW_Setting_up grass.png"
    }
    AutoImage{x: 28*hRatio; y:1137*vRatio
        source: "qrc:/pic/NW_Setting_down grass.png"
    }
            ...
            RadioButton {id: radioBtn
                ...
                style: RadioButtonStyle {
                    indicator:Item{
                        ...
                        AutoImage { source: "qrc:/pic/" + cursorImgList[group%4];
